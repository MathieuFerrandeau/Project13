...
urlpatterns = [
    ...
    path('outlay-deleted/<str:outlay_id>/', views.deleted_outlay_view,
         name='deleted_outlay'),
    path('outlay-modification/<str:outlay_id>/',
         views.outlay_modification_view,
         name='outlay_modification'),
    path('history/', views.history,
         name='history'),
    path('history/categories/<str:month_selected>/',
         views.history_categories_view,
         name='history_categories'),
    path('history/outlay/<str:month_selected>/<str:category_name>/',
         views.history_outlay_view,
         name='history_outlay'),
